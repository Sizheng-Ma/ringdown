...
np.savetxt('time_rest/mass4_overtone',mass_max_clu)
np.savetxt('time_rest/spin4_overtone',spin_max_clu)
np.savetxt('time_rest/tinit4_overtone',tssss)
np.savetxt('time_rest/bayes4_overtone',bayes_clu)
np.savetxt('time_rest/mass_peak4_overtone',mass_peak_clu)
np.savetxt('time_rest/chi_peak4_overtone',chi_peak_clu)
