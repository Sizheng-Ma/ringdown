...
np.savetxt('time_rest/mass6',mass_max_clu)
np.savetxt('time_rest/spin6',spin_max_clu)
np.savetxt('time_rest/tinit6',tssss)
np.savetxt('time_rest/bayes6',bayes_clu)
np.savetxt('time_rest/mass_peak6',mass_peak_clu)
np.savetxt('time_rest/chi_peak6',chi_peak_clu)
