...
np.savetxt('time_rest/mass4',mass_max_clu)
np.savetxt('time_rest/spin4',spin_max_clu)
np.savetxt('time_rest/tinit4',tssss)
np.savetxt('time_rest/bayes4',bayes_clu)
np.savetxt('time_rest/mass_peak4',mass_peak_clu)
np.savetxt('time_rest/chi_peak4',chi_peak_clu)
