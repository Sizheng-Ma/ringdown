...
np.savetxt('time_rest/bayes5_overtone',bayes_clu)
np.savetxt('time_rest/mass_peak5_overtone',mass_peak_clu)
np.savetxt('time_rest/chi_peak5_overtone',chi_peak_clu)
