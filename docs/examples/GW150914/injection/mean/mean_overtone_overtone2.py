...
np.savetxt('time_rest/mass2_overtone_overtone',mass_max_clu)
np.savetxt('time_rest/spin2_overtone_overtone',spin_max_clu)
np.savetxt('time_rest/tinit2_overtone_overtone',tssss)
np.savetxt('time_rest/bayes2_overtone_overtone',bayes_clu)
