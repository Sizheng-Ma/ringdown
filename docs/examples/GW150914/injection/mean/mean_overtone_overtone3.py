...
np.savetxt('time_rest/mass3_overtone_overtone',mass_max_clu)
np.savetxt('time_rest/spin3_overtone_overtone',spin_max_clu)
np.savetxt('time_rest/tinit3_overtone_overtone',tssss)
np.savetxt('time_rest/bayes3_overtone_overtone',bayes_clu)
