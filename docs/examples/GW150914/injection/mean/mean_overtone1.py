...
np.savetxt('time_rest/bayes1_overtone',bayes_clu)
np.savetxt('time_rest/snr1_overtone',snr_clu)
np.savetxt('time_rest/mass_peak1_overtone',mass_peak_clu)
np.savetxt('time_rest/chi_peak1_overtone',chi_peak_clu)
