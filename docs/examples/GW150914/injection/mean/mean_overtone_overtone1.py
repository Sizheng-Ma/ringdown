...
np.savetxt('time_rest/mass1_overtone_overtone',mass_max_clu)
np.savetxt('time_rest/spin1_overtone_overtone',spin_max_clu)
np.savetxt('time_rest/tinit1_overtone_overtone',tssss)
np.savetxt('time_rest/bayes1_overtone_overtone',bayes_clu)
