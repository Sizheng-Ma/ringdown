...
A1=fit.result.posterior.A[:,:,1].values.flatten()

np.savetxt('220_2/mass'+str(tinit),mass)
np.savetxt('220_2/spin'+str(tinit),spin)
np.savetxt('220_2/A0'+str(tinit),A0)
np.savetxt('220_2/A1'+str(tinit),A1)
